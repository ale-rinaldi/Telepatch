...
import org.telepatch.ui.ChatActivity;
...
public class MessagesController implements NotificationCenter.NotificationCenterDelegate {
    ...
    /**
     * this method do a call to Telegram servers and do a search based on a query.
     * @param query
     * @param uid
    ...
    public TLRPC.messages_Messages getMessages() {
        return messages;
    }
        ...
        long reqId = ConnectionsManager.getInstance().performRpc(req, new RPCRequest.RPCRequestDelegate() {
            ...
            public void run(TLObject response, TLRPC.TL_error error) {
                ...
                if (error == null) {
                    ...
                    processLoadedMessages(res, uid, 0, 50, Integer.MAX_VALUE, false, 0, 0, 0, 0, res.messages.get(0).date, false);
                    NotificationCenter.getInstance().postNotificationName(dialogsNeedReload);
