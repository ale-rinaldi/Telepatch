...
public class ContactsController {
    ...
    public void checkAppAccount() {
        ...
        if (recreateAccount) {
            ...
            if (UserConfig.currentUser != null) {
                try {
                    currentAccount = new Account(UserConfig.currentUser.phone, "org.telegram.telepatch.account");
...
//        query.add(builder.build());
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.telegram.telepatch.messenger.android.profile");
